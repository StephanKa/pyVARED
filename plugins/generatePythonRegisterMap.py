...
class GeneratePythonModule(TemplateGeneration):
    ...
    def _extract_register_information(self):
        ...
        for temp_reg in keylist:
            ...
            return_string += self.REGISTER_BIT_INFORMATION.format(
                self._extract_variable_name(temp_reg), self._extract_bit_defintion(self.parsed_file.register[temp_reg].bit_definition), add_property
            )
    ...
    def _write(self):
        ...
        self.output_file.write(f"class {self.parsed_file.component_name}(): # IP Core Version {self.parsed_file.ip_core_version}\n{out_string}\n\n")
