...
class GenerateCHeader(TemplateGeneration):
    ...
    def _extract_register_information(self):
        ...
        for temp_reg in keylist:
            ...
            return_string += self.REGISTER_BIT_INFORMATION.format(
                self._extract_variable_name(temp_reg), self._extract_bit_defintion(self.parsed_file.register[temp_reg].bit_definition)
            )
    ...
    def _write(self):
        ...
        self.output_file.write(self.COMPONENT_NAMING_AND_DEFINTION.format(self.parsed_file.component_name, self.parsed_file.ip_core_version, self._extract_register_information()))
